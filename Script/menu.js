...
const projects = [
  ...
  {
    title: 'To Do List',
    description: 'This is web application called (ToDo List), user can use it and userd data will not lose while refresh or close the brouser',
    image: './images/todolist.webp',
    featureList: ['html', 'bootstrap', 'Ruby'],
    seeLive: 'https://alanluqman.github.io/to-do-list/',
    seeSource: 'https://github.com/alanluqman/to-do-list',
  },
  {
    title: 'Awesome Books',
    description: 'This Project is about smart book library that user can save desired book here and keep it in its browser.',
    image: './images/awesomebooks.webp',
    featureList: ['html', 'bootstrap', 'Ruby'],
    seeLive: 'https://alanluqman.github.io/Awesome-books-Refactor/',
    seeSource: 'https://github.com/alanluqman/Awesome-books-Refactor',
  },
  {
    title: 'Annual Tech Forum',
    description: 'This website created for Annual Tech Forum, visitors can have detailed info about this forum every year as place, date, time, speakers and sponsors.',
    image: './images/annualTechForum.webp',
    featureList: ['html', 'bootstrap', 'Ruby'],
    seeLive: 'https://alanluqman.github.io/Annual-Tech-Forum/',
    seeSource: 'https://github.com/alanluqman/Annual-Tech-Forum',
  },
  {
    title: '5th Project',
    description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since 1500s, when an unknown printer took a galley of type and scrambled it 1960s with the releaLorem Ipsum is simply ummy text of the printing and typesetting industry. Lorem Ipsum has been the standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it 1960s with the releax map lapora verita.',
